...
def DrawLetter(letterCode, x, y, z):
    base = 16
    # Our font is 8 blocks wide, even though most letters have 3 blocks of
    # space
    num_of_bits = 8
    # Our font is 7 blocks high, so if we want it to go from the ground, move
    # up 7
    z = z - 7
    ...
    for value in letterCode:
        x = x - num_of_bits
        # For this version of the program we do the decoding all in a single
        # line
