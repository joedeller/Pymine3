...
# This is an older method of creating fonts, but works well with minecraft
# and blocks
...
def DrawLetter(letterCode, x, y, z):
    ...
    # Other font styles might use all 8 available blocks so each letter is
    # wider
    num_of_blocks = 8
    ...
    for value in letterCode:
        ...
        # air, we can finally draw the blocks that make up this line of our
        # letter
...
try:
    message = input('Enter a message to write in Minecraft: ')
except NameError:
    pass
