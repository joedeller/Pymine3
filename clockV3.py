...
hours_x = x
# The minutes are three letters to the right of the hours, 2 characters
# for the hours plus one for the ":"
...
while True:
    ...
    # make a note of what time we have just drawn ready to be checked for next
    # time
    last_hour = hour
    last_minute = minute
