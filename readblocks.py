...
# This program is quite slow , the larger the area you select, the slower
# it gets
...
for y in range(y_start, y_finish + 1):
    # the "\n" means start a new line, like you would do when writing in a
    # ruled notebook
    ...
    for z in range(z_start, z_finish + 1):
        ...
        for x in range(x_start, x_finish + 1, 1):
            ...
            # Secondly, does it have extra information, like a color,
            # direction, type
